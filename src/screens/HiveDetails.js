    ...
    return(
        <View style={styles.homeScreenParent}>
            <View style={styles.cardContainer}>
                <CachedImage source = {{uri: hiveImgData}} defaultSource = {require('/Users/omarmuniz/Documents/React Native/BasicNavigationAWS/BasicNav/assets/hive.png')} style={styles.hiveImage}/>
